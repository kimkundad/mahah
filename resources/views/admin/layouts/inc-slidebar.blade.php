<div id="kt_app_sidebar" 
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo" style="background: #000;">
        ...
        <a target="_blank" href="{{ url('/')}}">
                              ...
                              <img src="{{ get_site_logo() }}?v{{ time() }}" alt="Logo" class=" app-sidebar-logo-default" style="height:60px" />
               
                              <img src="{{ get_site_logo() }}?v{{ time() }}" alt="Logo" class="h-35px app-sidebar-logo-minimize" />
